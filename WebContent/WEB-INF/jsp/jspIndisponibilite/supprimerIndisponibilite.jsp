...
<title>Supprimer une Indisponibilité</title>
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
<link rel="stylesheet" type="text/css" href="css/projet.css" />
</head>
<body><!-- les ids des balises sont identiques dans cette jsp et la jsp supprimer un campus  -->
<div id="header">
...
<h3 id="titleAjouter"> SUPPRIMER UNE INDISPONIBILITE </h3> <br>
<h3 class="text-danger" id="messageAttentionSupprimerCampus"> Attention!! Est-ce que vous êtes sûr de supprimer Définitvement l'Indisponibilité que vous avez Chiosi ?!!...</h3>
...
<form  id="formAjouter" action="<%=request.getContextPath()%>/ServletSupprimerUneIndisponibilite" method="POST">
    <div class="form-group">
    <c:choose>
    <c:when test="${!empty supprimerIndisponibiliteException }">
