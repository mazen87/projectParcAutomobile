...
<jsp:include page="/WEB-INF/jsp/header.jsp"></jsp:include>
 ...
 <!-- tous les ids des balise sont identique dans cette jsp et la jsp supprimer campus ,l'affichage est identique  -->
<h3 id="titleAjouter"> SUPPRIMER UNE DESTINATION </h3> <br>
<h3 class="text-danger" id="messageAttentionSupprimerCampus"> Attention!! Est-ce que vous êtes sûr de supprimer Définitvement la Destination  que vous avez Chiosi ?!!...</h3>
...
<form  id="formAjouter" action="<%=request.getContextPath()%>/ServletSupprimerUneDestination" method="POST">
    <div class="form-group">
    <div id="boutonsAjouterCampus">
    <c:choose>
    <c:when test="${!empty supprimerDestinationException}">
