...
<title>Supprimer un Campus </title>
...
<h3 id="titleAjouter"> SUPPRIMER UN CAMPUS </h3> <br>
<h3 class="text-danger" id="messageAttentionSupprimerCampus"> Attention!! Est-ce que vous êtes sûr de supprimer Définitvement le Campus que vous avez Chiosi ?!!...</h3>
...
<form  id="formAjouter" action="<%=request.getContextPath()%>/ServletSupprimerUnCampus" method="POST">
