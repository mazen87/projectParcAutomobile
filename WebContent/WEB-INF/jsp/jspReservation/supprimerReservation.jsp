...
<h3 id="titleAjouter"> SUPPRIMER UNE RESERVATION </h3> <br>
<h3 class="text-danger" id="messageAttentionSupprimerCampus"> Attention!! Est-ce que vous êtes sûr de supprimer Définitvement La Réservation que vous avez Chiosi ?!!...</h3>


<div class="container-sm">
<!-- afficher les message pour les utilisateur  -->
<c:if test="${! empty supprimerReservationException }"><!-- message erreur concernant la suppression d'une Réservation -->
<p class="text-danger">${requestScope.supprimerReservationException }</p>
</c:if>
<c:if test="${ empty  supprimerVehiculeException }">
<p class="text-success">${requestScope.messageReussiteSupprimerReservation }</p><!-- message réussite concernant la suppression d'une Réservation -->
</c:if>
<div class="shadow-lg p-3 mb-5 bg-white rounded">
<form  id="formAjouter" action="<%=request.getContextPath()%>/ServletSupprimerUneReservation" method="POST">
