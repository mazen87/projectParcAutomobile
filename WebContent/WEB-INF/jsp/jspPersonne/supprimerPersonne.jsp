...
<body>
<body> <!-- tous les id des balise de cette jsp et la jsp supprimer campus sont identiques  -->
<div id="header">
...
<h3 id="titleAjouter"> SUPPRIMER UNE PERSONNE </h3> <br>
<h3 class="text-danger" id="messageAttentionSupprimerCampus"> Attention!! Est-ce que vous êtes sûr de supprimer Définitvement la Personne que vous avez Chiosi ?!!...</h3>
...
<form  id="formAjouter" action="<%=request.getContextPath()%>/ServletSupprimerPersonne" method="POST">
    <div class="form-group">
    <div id="boutonsAjouterCampus">
    <c:choose>
    <c:when test="${!empty messageExceptionSupprimer}">
